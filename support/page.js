    ...
    <div style={{minHeight:'100vh',fontFamily:'Inter,sans-serif',background:'#fff'}}>
      ...
      <div style={{maxWidth:680,margin:'0 auto',padding:'48px 24px'}}>
        ...
        <div style={{background:'#f8fafc',borderRadius:12,padding:24,marginBottom:16,border:'1px solid #e2e8f0'}}>
          ...
          <p style={{fontSize:13,color:'#475569'}}>Email us at <strong>support@hexoriq.com</strong> and we'll respond within 24 hours.</p>
        </div>
        <div style={{background:'#f0f4ff',borderRadius:12,padding:24,border:'1px solid #bfdbfe'}}>
          <h2 style={{fontSize:15,fontWeight:700,color:'#dc2626',marginBottom:8}}>Getting Started</h2>
          <p style={{fontSize:13,color:'#475569',lineHeight:1.6}}>HexorIQ is designed to be simple. If you run into any issues, our team is ready to help you get the most out of the product.</p>
        </div>
      </div>
    </div>
  )
