  ...
  if (error) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,sans-serif'}}>
      <div style={{textAlign:'center'}}>
        ...
        <Link href="/dashboard" style={{color:'#dc2626',textDecoration:'none'}}>← Back to dashboard</Link>
      </div>
    </div>
  )
    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',fontFamily:'Inter,sans-serif'}}>
      ...
      <div style={{maxWidth:760,margin:'0 auto',padding:'32px 24px'}}>
        <div style={{background:'#fff',border:'1px solid #e2e8f0',borderRadius:14,padding:24,marginBottom:16}}>
          <p style={{fontSize:11,fontWeight:700,color:'#dc2626',textTransform:'uppercase',marginBottom:4}}>Result</p>
