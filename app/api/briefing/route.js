...
export async function POST(request) {
  try {
    ...
    const prompt = `You are an AI assistant for HexorIQ. Generate a concise daily briefing in 2 sentences based on: ${JSON.stringify(body)}. Be specific and actionable.`
    ...
    return NextResponse.json({ briefing: 'Your HexorIQ dashboard is ready.' })
  }
}
