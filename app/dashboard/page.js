...
const COLOR = '#dc2626'
const PRODUCT_NAME = 'HexorIQ'
const PRODUCT_INITIAL = 'H'
const COOKIE = 'hex'
const ITEM_NAME = 'Reviews'
...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="hx1" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#f87171"/>
        <stop offset="100%" stopColor="#991b1b"/>
      </linearGradient>
    </defs>
    <path d="M50 10 L85 30 L85 70 L50 90 L15 70 L15 30 Z" fill="url(#hx1)"/>
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='hex_token=;max-age=0'; document.cookie='hex_user=;max-age=0'; router.push('/login') }}
