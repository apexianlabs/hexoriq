...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs><linearGradient id="lg" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#f87171"/><stop offset="100%" stopColor="#991b1b"/></linearGradient></defs>
    <path d="M50 10 L85 30 L85 70 L50 90 L15 70 L15 30 Z" fill="url(#lg)"/>
    <path d="M50 28 L54.5 41 L68 41 L57 49.5 L61 63 L50 55 L39 63 L43 49.5 L32 41 L45.5 41 Z" fill="white" opacity="0.95"/>
  </svg>
)
