    ...
    <div style={{width:220,background:'#0f172a',display:'flex',flexDirection:'column',minHeight:'100vh',flexShrink:0}}>
      <div style={{padding:'20px 16px',borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
        <Link href="/" style={{display:'flex',alignItems:'center',gap:8,textDecoration:'none'}}>
          <div style={{width:28,height:28,borderRadius:6,background:'#dc2626',display:'flex',alignItems:'center',justifyContent:'center',fontSize:13,fontWeight:800,color:'#fff'}}>H</div>
          <div>
            <p style={{fontSize:13,fontWeight:800,color:'#fff',lineHeight:1}}>HexorIQ</p>
            <p style={{fontSize:10,color:'#64748b',lineHeight:1,marginTop:2}}>AI-powered review intelligence</p>
          </div>
        </Link>
      </div>
      <div style={{padding:'12px 10px',flex:1}}>
        <Link href="/generate" style={{display:'flex',alignItems:'center',justifyContent:'center',gap:8,background:'#dc2626',color:'#fff',textDecoration:'none',borderRadius:8,padding:'10px 16px',fontSize:13,fontWeight:600,marginBottom:16}}>
      ...
      <div style={{padding:'12px 10px',borderTop:'1px solid rgba(255,255,255,0.08)'}}>
        <div style={{background:'rgba(255,255,255,0.05)',borderRadius:10,padding:'12px',marginBottom:8}}>
          ...
          <Link href="/billing" style={{display:'block',textAlign:'center',background:'#dc2626',color:'#fff',textDecoration:'none',borderRadius:6,padding:'6px',fontSize:11,fontWeight:600}}>
            Upgrade →
          </Link>
        </div>
        <div style={{display:'flex',alignItems:'center',gap:8,padding:'8px 10px',cursor:'pointer'}} onClick={handleLogout}>
          <div style={{width:28,height:28,borderRadius:8,background:'#dc2626',display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:700,color:'#fff',flexShrink:0}}>
            {getInitials(user)}
          </div>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',minWidth:0}}>
        <div style={{background:'#fff',borderBottom:'1px solid #e2e8f0',minHeight:56,display:'flex',alignItems:'center',padding:'8px 20px',gap:12,flexShrink:0}}>
          ...
          <div style={{flex:1}}>
            ...
            <p style={{fontSize:12,color:'#94a3b8',marginTop:2}}>Here's your HexorIQ activity.</p>
          </div>
          <Link href="/generate" style={{background:'#dc2626',color:'#fff',padding:'7px 16px',borderRadius:8,fontSize:13,fontWeight:600,textDecoration:'none',flexShrink:0}}>
            + New Result
          </Link>
        </div>
        <div style={{flex:1,padding:'24px',overflowY:'auto'}}>
          ...
          <div style={{background:'#fff',borderRadius:12,border:'1px solid #e2e8f0',overflow:'hidden'}}>
            <div style={{padding:'16px 20px',borderBottom:'1px solid #f1f5f9',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
              ...
              <Link href="/generate" style={{background:'#dc2626',color:'#fff',padding:'6px 14px',borderRadius:7,fontSize:12,fontWeight:600,textDecoration:'none'}}>+ New</Link>
            </div>
            {loading ? (
              ...
              <div style={{padding:48,textAlign:'center'}}>
                ...
                <Link href="/generate" style={{background:'#dc2626',color:'#fff',padding:'8px 16px',borderRadius:8,fontSize:12,fontWeight:600,textDecoration:'none'}}>
              ...
              <div key={item.id} style={{padding:'14px 20px',display:'flex',alignItems:'center',justifyContent:'space-between',borderBottom: i < 4 ? '1px solid #f8fafc' : 'none'}}>
                <div style={{display:'flex',alignItems:'center',gap:12,minWidth:0,flex:1}}>
                  <div style={{width:36,height:36,borderRadius:8,background:'#f0f4ff',display:'flex',alignItems:'center',justifyContent:'center',fontSize:13,fontWeight:700,color:'#dc2626',flexShrink:0}}>
                ...
                <Link href={`/items/${item.id}`} style={{color:'#dc2626',fontSize:12,fontWeight:600,textDecoration:'none',padding:'5px 12px',border:'1px solid #e2e8f0',borderRadius:6,flexShrink:0,marginLeft:12}}>
                  View →
                </Link>
              </div>
            ))}
