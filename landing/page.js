    ...
    <div style={{minHeight:'100vh',fontFamily:'Inter,sans-serif',background:'#fff',color:'#0f172a'}}>
      <nav style={{position:'sticky',top:0,zIndex:100,background:'rgba(255,255,255,0.95)',backdropFilter:'blur(8px)',borderBottom:'1px solid #e2e8f0',padding:'0 20px',height:56,display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        <div style={{display:'flex',alignItems:'center',gap:8}}>
          ...
          <span style={{fontWeight:800,fontSize:16,color:'#0f172a'}}>HexorIQ</span>
        </div>
        <div style={{display:'flex',gap:8}}>
          <Link href="/login" style={{padding:'7px 14px',fontSize:13,color:'#475569',textDecoration:'none',fontWeight:500}}>Log in</Link>
          <Link href="/signup" style={{padding:'8px 16px',fontSize:13,background:'#dc2626',color:'#fff',textDecoration:'none',borderRadius:8,fontWeight:600}}>Start Free Trial</Link>
        </div>
      </nav>

      <section style={{padding:'80px 20px 60px',textAlign:'center',background:'linear-gradient(180deg,#f8fafc 0%,#fff 100%)'}}>
        <div style={{display:'inline-flex',alignItems:'center',gap:6,background:'#f0f4ff',border:'1px solid #bfdbfe',borderRadius:20,padding:'4px 12px',fontSize:11,color:'#dc2626',fontWeight:700,marginBottom:20,textTransform:'uppercase',letterSpacing:'0.05em'}}>
          ⚡ AI-POWERED
        </div>
        ...
        <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap',marginBottom:16}}>
          <Link href="/signup" style={{padding:'12px 28px',background:'#dc2626',color:'#fff',textDecoration:'none',borderRadius:10,fontWeight:700,fontSize:15}}>
            Start Free Trial →
          </Link>
          <Link href="/login" style={{padding:'12px 28px',background:'#fff',color:'#dc2626',textDecoration:'none',borderRadius:10,fontWeight:700,fontSize:15,border:'2px solid #e2e8f0'}}>
            Log in
          </Link>
        </div>
      ...
      <section style={{padding:'60px 20px',background:'#dc2626',textAlign:'center'}}>
        <h2 style={{fontSize:30,fontWeight:800,color:'#fff',marginBottom:12}}>Ready to get started?</h2>
        <p style={{fontSize:15,color:'rgba(255,255,255,0.8)',marginBottom:28}}>Join thousands of professionals saving time with HexorIQ.</p>
        <Link href="/signup" style={{padding:'13px 28px',background:'#fff',color:'#dc2626',textDecoration:'none',borderRadius:10,fontWeight:700,fontSize:15}}>
          Start Free Trial →
        </Link>
      </section>
