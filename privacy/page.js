    ...
    <div style={{minHeight:'100vh',fontFamily:'Inter,sans-serif',background:'#fff'}}>
      ...
      <div style={{maxWidth:680,margin:'0 auto',padding:'48px 24px'}}>
        ...
        {[
          ...
          { title:'How We Use Your Information', body:'We use your information to provide and improve HexorIQ, send important service updates, and process payments. Your data is used solely to provide the service and is never shared with third parties.' },
          ...
          { title:'Contact Us', body:'For privacy-related questions, contact us at privacy@hexoriq.com' },
        ].map(s => (
